...
excerpt: 'Why another web framework?'
...
<Image
  alt={`Enhance Hero`}
  src={`/images/enhance/enhance.png`}
  width={1600}
  height={840}
/>
...
_**Update**_ You can import things into your custom element file. I was wrong. I had a particular issue when I was importing my `currencyFormatter` function into my custom element file. I was getting an error that said `currencyFormatter`. I was able to get around this by adding the function to the api route and returning it in the get method. I then added it to the custom element's store and was able to use it in the html. I should have done more investigating because I'm not exactly sure why I was getting that error but removing it solved the issue for me.

I spoke with Simon MacDonald on the Enhance team and he helped me with this. Which I should also say, the Enhance team is incredibly helpful and responsive. I have had a great experience with them. Their discord is very active and they get to questions pretty quickly.
