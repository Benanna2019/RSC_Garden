...
excerpt: "React Server Components let us use old school forms with actions"
...
![image](https://cdn.sanity.io/images/nfspldzq/production/4a7941fa92371ec9c9f2f52d26c15dcac5922ceb-1080x1080.png?w=450)
...
export async function POST(request: NextRequest) {
    ...
    const { data, error } = await supabase.from("messages").insert([{ content: message, user_id: session.user.id }])
